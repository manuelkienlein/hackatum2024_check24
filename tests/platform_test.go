...
func TestGetOffersPlattformBase(t *testing.T) {
	...
	//TODO
	req := httptest.NewRequest(http.MethodGet, "/api/offers?regionID=0&timeRangeEnd=1673568000000&timeRangeStart=1673395200000&numberDays=3&sortOrder=price-asc&page=0&pageSize=100&priceRangeWidth=10&minFreeKilometerWidth=50", nil)
	resp, _ := app.Test(req)
