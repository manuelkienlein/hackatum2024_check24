...
func TestGetOffers2(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/api/offers?minFreeKilometerWidth=50&numberDays=3&page=0&pageSize=100&priceRangeWidth=10&regionID=0&sortOrder=price-asc&timeRangeEnd=1592179200000&timeRangeStart=1591912800&minNumberSeats=5", nil)
	resp, err := app.Test(req)
