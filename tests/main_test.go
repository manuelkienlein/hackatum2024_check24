...
func TestGetOffers2(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/api/offers?minFreeKilometerWidth=50&numberDays=1&page=0&pageSize=100&priceRangeWidth=10&regionID=37&sortOrder=price-asc&timeRangeEnd=1692179200000&timeRangeStart=1491920000000&minPrice=1810&maxPrice=1820", nil)
	resp, err := app.Test(req)
